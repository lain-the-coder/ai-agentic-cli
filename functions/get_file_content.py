...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="List all the content of a file for the provided file path, relative to the working directory",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="File path who's content is requested to be listed, relative to the working directory",
            ),
        },
        required=["file_path"]
    ),
